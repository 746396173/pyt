...
def send_email(email, code):
    ...
    text_content = '''感谢注册www.liujiangblog.com，这里专注于分享！\
                    如果你看到这条消息，说明你的邮箱服务器不提供HTML链接功能，请联系管理员！'''

    html_content = '''
                    <p>感谢注册<a href="http://{}/confirm/?code={}" target=blank>点击确认注册!</a>，\
                    </p>
                    <p>请点击站点链接完成注册确认！</p>
                    <p>此链接有效期为{}天！</p>
        ...
        if login_form.is_valid():
            ...
            try:
                ...
                if user.password == hash_code(password):
                    ...
                    request.session['user_kami'] = user.kami
                    return redirect('/index/')
                else:
                    message = "密码不正确！"
            except:
...
确保不留后患。但也有不好的地方，那就是如果你在session中夹带了一点‘
私货’，会被一并删除，这一点一定要注意。'''
