...
def shujuku(ui, u, d):
    ...
    # SQL 插入语句
    sql = """INSERT INTO dm3(uid,user,danmu)
...
if __name__ == "__main__":
    ...
    print("288016/n729149/n122402/n1126960")
    ...
    for room in room_tup:
        # print(t)
        p1 = multiprocessing.Process(target=d_m, name=room, args=(t, int(room)))
        print("-------start---------")
        print(p1.name)
        p1.start()
